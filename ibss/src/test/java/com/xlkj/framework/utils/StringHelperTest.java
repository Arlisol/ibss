...
import com.xlkj.framework.utils.StringHelper;
/**
 * @author badqiu
 */
...
//		assertEquals("abc 123","abc \n\t123".replace('\n', ' '));
	...
	@Test
	public void test_sqlFormatForSQlServer2005(){
		String expected ="select ROW_NUMBER() OVER (ORDER BY id) AS Row * from blog";
		String actual =StringHelper.sqlFormatForSQlServer2005("select * from blog","id");
