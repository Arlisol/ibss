	...
	<body>
		...
		<div class="content">
			<div class="page-header">
				<h1 class="title">菜单修改</h1>
				<ol class="breadcrumb">
					<li class="active">菜单管理</li>
					<li>
						<a href="${ctx}/menu/list">菜单查询</a>
					</li>
					<li class="active">菜单修改</li>
				</ol>
			</div>
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form class="form-horizontal" id="menuForm" action="${ctx}/menu/submitModify/${getMenu.menuKey}" method="post" >								 
									<div class="form-group">
										<label class="col-lg-2 col-xs-2 control-label form-label">菜单名称：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="menuName" class="form-control" name="menuName" value="${getMenu.menuName}"/>
											<input type="hidden" id="hidMenuName" class="form-control" value="${getMenu.menuName}"/>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">菜单等级：</label>
										<div class="radio radio-inline">
											<input type="radio" id="one" name="menuLevel" value="1" <c:if test="${getMenu.menuLevel eq '1'}">checked="checked"</c:if>/>
											<label for="one">一级</label>
										</div>						
										<div class="radio radio-inline">
											<input type="radio" id="two" name="menuLevel" value="2" <c:if test="${getMenu.menuLevel eq '2'}">checked="checked"</c:if>/>
									...
									<div class="form-group" id="first">
										...
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="groupSequence" class="form-control" name="groupSequence" value="${getMenu.groupSequence}"/>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">菜单Logo码：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="menuLogo" class="form-control" name="menuLogo" value="${getMenu.menuLogo}"/>
										</div>	
									</div>
									<div class="form-group" id="second">
										<label class="col-lg-2 col-xs-2 control-label form-label">二级菜单排序码：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="menuSequence" class="form-control" name="menuSequence" value="${getMenu.menuSequence}"/>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">菜单链接：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="menuURL" class="form-control" name="menuURL" value="${getMenu.menuURL}"/>
										</div>	
									</div>	
									<div class="form-group">
										<label class="col-lg-2 col-xs-2 control-label form-label">用户类型：</label>
										<div class="col-lg-3 col-xs-3 ">
											<tags:wselect key="userType" name="userType" value="${getMenu.userType}"/>
										</div>
										...
										<div class="col-lg-3 col-xs-3 " id="fourth">
											<select class="selectpicker"  id="parentMenuKey"  name="search_parentMenuKey">
										    	...
										    	<c:forEach var="menuLevel1List" items="${menuLevel1List}">
											    	...
											    	<c:if test="${menuLevel1List.menuKey eq getMenu.parentMenuKey}">selected="selected"</c:if>>${menuLevel1List.menuName} </option>
												</c:forEach>
											</select>
										</div>
									</div>																																														
									<div class="form-group">
										...
										<div class="col-lg-8 col-xs-8">
											<textarea class="form-control" rows="4" id="remark" name="remark" >${getMenu.remark}</textarea>
										</div>
									</div>																																																				
									<div class="form-group">
