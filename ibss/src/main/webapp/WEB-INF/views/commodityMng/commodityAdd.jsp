					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form class="form-horizontal" id="commodityForm" action="${ctx}/commodity/submitAdd" method="post" >								 
										...
										<div class="col-lg-3 col-xs-3 ">
											<select class="selectpicker"  id="commodityClassKey"  name="commodityClassKey">
										    	...
										    	<c:forEach var="commodityClassList" items="${commodityClassList}">
											    	<option value="${commodityClassList.commodityClassKey}">${commodityClassList.commodityClassName} </option>
												</c:forEach>
											</select>
										</div>	
									</div>	
									<div class="form-group" >
										...
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="commodityID" class="form-control" name="commodityID" placeholder="大写字母+数字"/>
										</div>
