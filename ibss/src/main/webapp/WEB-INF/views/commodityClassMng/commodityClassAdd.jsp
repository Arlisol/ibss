					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form class="form-horizontal" id="commodityClassForm" action="${ctx}/commodityClass/submitAdd" method="post" >								 
									<div class="form-group">
										<label class="col-lg-2 col-xs-2 control-label form-label">商品类别名称：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="commodityClassName" class="form-control" name="commodityClassName"/>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">商品类别ID：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="commodityClassID" class="form-control" name="commodityClassID" placeholder="大写字母+数字"/>
										</div>	
									</div>																																																						
									<div class="form-group">
