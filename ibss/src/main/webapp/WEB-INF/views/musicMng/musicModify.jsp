					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form class="form-horizontal" id="musicForm" action="${ctx}/music/submitModify/${getMusic.musicKey}" 
								onsubmit="return submitForm()" method="post" >								 
									<div class="form-group">
										<label class="col-lg-2 col-xs-2 control-label form-label">音乐名称：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="musicName" class="form-control" name="musicName" value="${getMusic.musicName}"/>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">歌手：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="singer" class="form-control" name="singer" value="${getMusic.singer}"/>
										</div>	
									</div>	
									<div class="form-group" >
										<label class="col-lg-2 col-xs-2 control-label form-label">专辑：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="album" class="form-control" name="album" value="${getMusic.album}"/>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">音乐风格：</label>
										<div class="col-lg-3 col-xs-3 ">
											<tags:wselect key="musicStyle" name="musicStyle" value="${getMusic.musicStyle}"/>
										</div>	
									</div>
									<div class="form-group" >
										...
										<div class="col-lg-3 col-xs-3 ">
											<div class="input-prepend input-group">
												...
												<input type="text" id="issueDate" class="form-control" name="issueDate" value="${getMusic.issueDate}"/>
											</div>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">时长：</label>
										<div class="col-lg-1 col-xs-1 ">
											<input type="text" id="minute" class="form-control" name="minute" placeholder="分" value="${getMusic.minute}"/>											
										</div>
										<div class="col-lg-1 col-xs-1" style="width:10px">
											<p class="form-control-static">:</p>
										</div>
										<div class="col-lg-1 col-xs-1 ">
											<input type="text" id="second" class="form-control" name="second" placeholder="秒" value="${getMusic.second}"/>
										</div>	
									</div>	
									<div class="form-group">
										<label class="col-lg-2 col-xs-2 control-label form-label">填词：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="doWords" class="form-control" name="doWords" value="${getMusic.doWords}"/>
										</div>
										<label class="col-lg-2 col-xs-2 control-label form-label">谱曲：</label>
										<div class="col-lg-3 col-xs-3 ">
											<input type="text" id="writeMusic" class="form-control" name="writeMusic" value="${getMusic.writeMusic}"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 col-xs-2 control-label form-label">语言：</label>
										<div class="col-lg-3 col-xs-3 ">
											<tags:wselect key="language" name="language" value="${getMusic.language}"/>
										</div>
									</div>																																															
									<div class="form-group">
										<label class="col-lg-2 col-xs-2 control-label form-label">备注：</label>
										<div class="col-lg-8 col-xs-8">
											<textarea class="form-control" rows="4" id="remark" name="remark" >${getMusic.remark}</textarea>
										</div>
									</div>																																																				
									<div class="form-group">
