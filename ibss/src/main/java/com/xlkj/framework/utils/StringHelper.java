...
public class StringHelper {
   ...
   public static String escapeXml(String str,String escapeChars) {
	...
	public static String sqlFormatForSQlServer2005(String sql,String order){
		
		String insertValue = String.format("ROW_NUMBER() OVER (ORDER BY %s) AS Row ,", order);
		
		return insertTokenIntoSelectSql(sql,insertValue);
   ...
   public static String defaultString(Object value) {
	...
	/**将字符转化为首字母大写 copy from spring*/
	public static String capitalize(String str) {
		return changeFirstCharacterCase(str, true);
	}
	
	/**将字符转化为首字母小写 copy from spring*/
